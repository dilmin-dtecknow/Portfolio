...
import type { Testermonials } from "../types";
import { getTestermonials } from "../lib/api";
import RatingAnim from "./animation/RatingAnim";
...
export default function Testimonials() {
  ...
  const [testimonials, setTestimonials] = useState<Testermonials[]>([]);
