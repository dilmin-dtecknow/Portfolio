  ...
  return (
    <section className="technologies" id="technologies" ref={ref}>
      ...
      >
        ...
        <motion.div className="tech-categories" variants={containerVariants}>
          {aboutData?.technologies.map((item) => (
            <motion.div
              key={item.category}
            ...
            >
              <h3>{item.category}</h3>
              <motion.div className="tech-badges" variants={containerVariants}>
